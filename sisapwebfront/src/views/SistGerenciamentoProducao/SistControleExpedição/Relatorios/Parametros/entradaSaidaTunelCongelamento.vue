<template>
      ...
      <v-col cols="12" sm="6" md="12" class="content">
        <div class="input">
        <span style="padding-top: 15px;margin-left:25px;">Data de produção</span>
      ...
      <v-col cols="12" sm="6" md="12" class="content">
        <div class="input">
          <span style="padding-top: 15px;margin-left:15%;">Turno</span>
          <v-radio-group v-model="rgShift"  column dense  style="margin-left:15%;transform: scale(0.9);">
        ...
        <div class="input">
          <span style="padding-top: 15px;">Turno</span>
          <v-radio-group v-model="rgPeriod"  column dense  style="margin-left:15%;transform: scale(0.9);" :disabled="rgShift === '3'">
            <v-radio label="1º Período" value="1"></v-radio> 
            <v-radio label="2º Período" value="2" ></v-radio>
            <v-radio label="Todos" value="3" ></v-radio>
          </v-radio-group>
        </div>
      </v-col>
